...
Реально подключённый каталоговый срез: чтение проектов; чтение и изменение направлений, площадок, преподавателей, групп и детей; создание/изменение направлений ребёнка. Нереализованные маршруты из таблицы возвращают `501 NOT_IMPLEMENTED`.
