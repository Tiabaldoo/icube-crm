...
Реально подключённый первый срез: чтение проектов; чтение и изменение направлений, площадок, преподавателей, групп и детей; создание/изменение направлений ребёнка. Остальные маршруты из таблицы пока возвращают `501 NOT_IMPLEMENTED`.
